...
if (sysop) {
  ...
  var oi = newMessage.guild.roles.find("name", "😡 Sysop Warn 😡")        // variaveis
    if (oi == null ){
        ...
        oldMessage.delete();
         if(!newMessage.guild.members.get(newMessage.mentions.users.first().id).roles.find("name", "😡 Sysop Warn 😡")) {
            newMessage.guild.members.get(newMessage.mentions.users.first().id).addRole(newMessage.member.guild.roles.find("name", "😡 Sysop Warn 😡")) 
            newMessage.guild.members.get(newMessage.mentions.users.first().id).addRole(newMessage.member.guild.roles.find("name", "Invite Post (1/3)")) 
...
if (sysop && sysop.inv && oldMessage.content.search('discord.gg') > -1) {
        oldMessage.delete();
if(newMessage.guild.members.get(newMessage.mentions.users.first().id).roles.find("name", "Invite Post (1/3)")) {
         newMessage.guild.members.get(newMessage.mentions.users.first().id).removeRole(newMessage.member.guild.roles.find("name", "Invite Post (1/3)"))
         newMessage.guild.members.get(newMessage.mentions.users.first().id).addRole(newMessage.member.guild.roles.find("name", "Invite Post (2/3)"))
...
if (sysop && sysop.inv && oldMessage.content.search('discord.gg') > -1) {
        oldMessage.delete();
    if(newMessage.guild.members.get(newMessage.mentions.users.first().id).roles.find("name", "Invite Post (2/3)")) {
        newMessage.guild.members.get(newMessage.mentions.users.first().id).removeRole(newMessage.member.guild.roles.find("name", "Invite Post (2/3)"))
         newMessage.guild.members.get(newMessage.mentions.users.first().id).addRole(newMessage.member.guild.roles.find("name", "Invite Post (3/3)"))
